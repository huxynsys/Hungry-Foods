...
<body>
    <nav class="navbar navbar-dark bg-primary mb-4">
        <div class="container-fluid">
            ...
            <div>
                <a href="manage-orders.php" class="btn btn-light btn-sm me-2">Orders</a>
                    ...
                    <form method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-1"><strong>Preference:</strong> <?php echo ucfirst(htmlspecialchars($row['preference'] ?? '')); ?></p>
